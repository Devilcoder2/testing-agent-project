...
export default function Home() {
  ...
  async function createProduct(event: FormEvent<HTMLFormElement>) {
    event.preventDefault(); setProductMessage("");
    try {
    ...
    } catch (error) { setProductMessage(error instanceof Error ? error.message : "Could not create Product."); }
  }
