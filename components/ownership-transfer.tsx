...
export function OwnershipTransfer({ label, currentOwnerId, membersPath, transferPath, onTransferred, onOpen, triggerClassName, triggerRole, triggerVariant = "secondary" }: { label: string; currentOwnerId: string; membersPath: string; transferPath: string; onTransferred: () => void; onOpen?: () => void; triggerClassName?: string; triggerRole?: "menuitem"; triggerVariant?: "primary" | "secondary" | "ghost" | "danger" }) {
