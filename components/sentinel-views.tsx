...
type TestCaseSummary = { id: string; name: string; currentVersion: number; product: Product; owner: { displayName: string }; updatedAt: string; featureLabels?: FeatureLabel[] };
