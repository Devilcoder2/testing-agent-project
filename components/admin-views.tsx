...
type PilotLead = { id: string; email: string; name: string; company: string | null; qaTeamSize: "1" | "2-5" | "6-15" | "16+" | null; status: PilotLeadStatus; createdAt: string; updatedAt: string };
